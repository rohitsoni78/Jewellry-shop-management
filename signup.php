...
<div class=" col-lg-7">
  <div class="register-logo">
    <a href="#"><b> Jewellery Shop managament </b></a>
  </div>
<?php session_start() ?>
	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		<div class="col-md-6 border-right">
			          ...
			          <!-- <input type="text" class="form-control" name="firstname" required placeholder="First Name" value="<?php echo isset($firstname) ? $firstname : '' ?>" pattern="[A-Za-z]+">  -->
					  <input type="text" class="form-control" name="firstname" required placeholder="First Name" pattern="[A-Za-z]+" title="Only letters are allowed" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')">
			        ...
			        <div class="input-group mb-3">
			          <input type="text" class="form-control" name="middlename"  placeholder="Middle Name" value="<?php echo isset($middlename) ? $middlename : '' ?>" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')">
			          <div class="input-group-append">
			            <div class="input-group-text">
			              <span class="fas fa-user"></span>
			            </div>
			        ...
			        <div class="input-group mb-3">
			          <!-- <input type="Number" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="contact" required placeholder="Contact Number" value="<?php echo isset($contact) ? $contact : '' ?>"> -->
					  <input type="text" class="form-control" name="contact" required placeholder="Contact Number" maxlength="10" pattern="[0-9]{10}" title="Enter exactly 10 digits" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,10)" value="<?php echo isset($contact) ? $contact : '' ?>">
					  <div class="input-group-append">
			            <div class="input-group-text">
